...
<template>
  <div>
            ...
            <el-row :gutter="10">
              ...
              <el-col :lg="12" :offset="0" class="row-mb">
                <el-button
                  ...
                  style="width: 100%"
                  size="small"
                  @click="toSetupCommandManagerPanel"
                >{{ $t("terminal.setupCommandManager") }}</el-button>
              </el-col>
              <!-- 终端设置 -->
              <el-col :lg="12" :offset="0" class="row-mb">
                <el-button
    ...
    <!-- 启动命令设置 -->
    <SetupCommandManager
      v-model:visible="SetupCommandManagerPanel.visible"
      v-model:config="SetupCommandManagerPanel"
...
import SetupCommandManager from "./SetupCommandManager";
...
export default {
  ...
  methods: {
    ...
    toSetupCommandManagerPanel(){
      this.SetupCommandManagerPanel = {
        ...this.instanceInfo.config.terminalOption,
        startCommand: this.instanceInfo.config.startCommand
      };
      this.SetupCommandManagerPanel.visible = true;
    },
    ...
    async instanceConfigUpdate() {
      try {
        ...
        this.SetupCommandManagerPanel.visible = false;
